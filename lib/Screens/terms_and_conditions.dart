...
class terms_and_conditions extends StatefulWidget{
  @override
  State<terms_and_conditions> createState() => _termsandconditionsState();
}

class _termsandconditionsState extends State<terms_and_conditions>{
  @override
                        ...
                        child: RichText(
                          text: TextSpan(
                            ...
                            children: <TextSpan> [
                              ...
                              TextSpan(text: 'Interpretation and Definitions:\n',style: TextStyle(fontWeight: FontWeight.bold)),
                              ...
                              TextSpan(
                                  ...
                                  'For the purposes of these Terms and Conditions:\n'
                                      '» Application means the software program provided by the Company downloaded by You on any electronic device, named Instant Resume Maker.\n\n'
                                      '» Application Store means the digital distribution service operated and developed by Apple Inc. (Apple App Store) or Google Inc. (Google Play Store) in which the Application has been downloaded.\n\n'
                                      '» Affiliate means an entity that controls, is controlled by or is under common control with a party, where "control" means ownership of 50% or more of the shares, equity interest or other securities entitled to vote for election of directors or other managing authority.\n\n'
                                      '» Country refers to: Haryana, India.\n\n'
                                      '» Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Instant Resume Maker.\n\n'
                              ...
                              TextSpan(text: 'Links to Other Websites\n',style: TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(
                                  text:
                              ...
                              TextSpan(text: '"AS IS" and "AS AVAILABLE" Disclaimer\n',style: TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(
                                  text:
                              ...
                              TextSpan(text: 'Disputes Resolution\n',style: TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(
                                text:
                                'If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.\n\n',
                              ),

                              TextSpan(text: 'For European Union (EU) Users\n',style: TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(
                                text:
                                'If You are a European Union consumer, you will benefit from any mandatory provisions of the law of the country in which you are resident in.\n\n',
                              ),

                              TextSpan(text: 'United States Legal Compliance\n',style: TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(
                                text:
                                'You represent and warrant that (i) You are not located in a country that is subject to the United States government embargo, or that has been designated by the United States government as a "terrorist supporting" country, and (ii) You are not listed on any United States government list of prohibited or restricted parties.\n\n',
                              ),

                              TextSpan(text: 'Severability and Waiver\n',style: TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(text: 'Severability\n',style: TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(
                                text:
                                'If any provision of these Terms is held to be unenforceable or invalid, such provision will be changed and interpreted to accomplish the objectives of such provision to the greatest extent possible under applicable law and the remaining provisions will continue in full force and effect.\n\n',
                              ),

                              TextSpan(text: 'Waiver\n',style: TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(
                                text:
                              ...
                              TextSpan(text: 'Translation Interpretation\n',style: TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(
                                text:
                                'These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.\n\n',
                              ),

                              TextSpan(text: 'Changes to These Terms and Conditions\n',style: TextStyle(fontWeight: FontWeight.bold)),
                              TextSpan(
                                text:
