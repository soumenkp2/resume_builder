...
class Template_4 extends StatefulWidget
{
  Type previousPage;
  ...
  Template_4(this.previousPage,this.edu_list, this.work_list, this.project_list, this.profile_list, this.achievement_list, this.skill_list, this.language_list);

  @override
  State<StatefulWidget> createState() => Template_4state();
}
...
class Template_4state extends State<Template_4>
{
  ...
  Widget route() {
    ...
    else return FormListPage(tableIndex: 4);
  }
}
