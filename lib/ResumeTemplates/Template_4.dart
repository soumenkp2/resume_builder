...
class Template_4 extends StatefulWidget
{
  ...
  Template_4(this.edu_list, this.work_list, this.project_list, this.profile_list, this.achievement_list, this.skill_list, this.language_list);
