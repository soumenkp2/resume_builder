...
class Resume_temp2 extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => Resume_temp2state();
}

//const Resume_temp2_state ({ Key? key, this.serverIP }): super(key: key);

class Resume_temp2state extends State<Resume_temp2> {
  @override
  void initState() {
    super.initState();
    ...
    widget.project_list =
        new List<Work_Projects_UserModel>.empty(growable: true);
    widget.skill_list =
        new List<Skills_Languages_UserModel>.empty(growable: true);
    widget.achievement_list =
        new List<Achievements_UserModel>.empty(growable: true);
    ...
    widget.edu_list?.elementAt(0).qualification_name =
        "BTech - Computer Science Engineering";
    widget.edu_list?.elementAt(0).organization_name =
    ...
    widget.achievement_list?.elementAt(0).organization_name =
        "Smart India Hackathon 2022";

    widget.achievement_list?.add(new Achievements_UserModel());
    widget.achievement_list?.elementAt(1).qualification_name = "Winner";
    widget.achievement_list?.elementAt(1).organization_name =
        "Smart India Hackathon 2022";
  ...
  void _createPDF() async {
    String? name = profile_list?.elementAt(0).name!;
    print(name);
  ...
  void _printScreen() {
    Printing.layoutPdf(onLayout: (PdfPageFormat format) async {
      ...
      //return PdfApi.saveDocument(name: 'my_resume.pdf', pdf: doc);
      return doc.save();
    });
  }
}
