...
class Template_2 extends StatefulWidget
{
  ...
  Template_2(this.previousPage,this.edu_list, this.work_list, this.project_list, this.profile_list, this.achievement_list, this.skill_list, this.language_list);
...
class Template_2state extends State<Template_2>
{
  ...
  {
    final file = await pdfResumeApi.generate(widget.profile_list,widget.edu_list,widget.work_list,widget.project_list,widget.achievement_list,widget.skill_list,widget.language_list,"white","black","blueGrey",2);
  ...
  Widget route() {
    ...
    else return FormListPage(tableIndex: 2);
  }
}
