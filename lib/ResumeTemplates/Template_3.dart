...
class Template_3 extends StatefulWidget
{
  Type previousPage;
  ...
  Template_3(this.previousPage,this.edu_list, this.work_list, this.project_list, this.profile_list, this.achievement_list, this.skill_list, this.language_list);

  @override
  State<StatefulWidget> createState() => Template_3state();
}
...
class Template_3state extends State<Template_3>
{
  ...
  {
    final file = await pdfResumeApi.generate(widget.profile_list,widget.edu_list,widget.work_list,widget.project_list,widget.achievement_list,widget.skill_list,widget.language_list,"teal","white","teal",3);
  ...
  Widget route() {
    ...
    else return FormListPage(tableIndex: 3);
  }
