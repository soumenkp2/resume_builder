...
class pdfResumeApi {
  static Future<File> generate(
      ...
      List<Achievements_UserModel>? ach_list,
      List<Skills_Languages_UserModel>? skill_list,
      List<Skills_Languages_UserModel>? lang_list,
      String color,
      String txt_color,
      String high_color,
      int index) async {
    ...
    pdf.addPage(MultiPage(
      ...
      build: (context) => [
        resume_temp(profile_list, edu_list, work_list, project_list, ach_list,
            skill_list, lang_list, color, txt_color, high_color, index),
      ],
    ));
  ...
  static Widget resume_temp(
          ...
          String high_color,
          int index) =>
      set_template(profile_list, edu_list, work_list, project_list, ach_list,
          skill_list, lang_list, color, txt_color, high_color, index);
}
...
Widget set_template(
  ...
  if (index == 1 || index == 2 || index == 3 || index == 4) {
    return Template_1(profile_list, edu_list, work_list, project_list, ach_list,
        skill_list, lang_list, color, txt_color, high_color);
  } else if (index == 5 || index == 6) {
    return Template_3(profile_list, edu_list, work_list, project_list, ach_list,
        skill_list, lang_list, color, txt_color, high_color);
  } else {
...
bool check_visibility_work_project(List<Work_Projects_UserModel>? list) {
  ...
  list?.forEach((value) {
    if (value.tableName == null ||
        ...
        value.year_duration == null && value.brief == null) {
      check = false;
    } else {
      check = true;
    }
...
List<Widget> createRow_1(
  ...
  if (row1.isEmpty) {
    ...
    if (check_visibility_work_project(work_list) == true) {
      row1.add(pdf_project_work(
          work_list, color, txt_color, high_color, "Work Experience"));
    }
...
List<Widget> createRow_2(
  ...
  if (row2.isEmpty) {
    ...
    if (check_visibility_work_project(project_list) == true) {
      row2.add(
        pdf_project_work(
            project_list, color, txt_color, high_color, "Projects"),
      );
    }
          ...
          child: new Row(
              ...
              children: <Widget>[
                new Flexible(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: createRow_1(edu_list, work_list, lang_list, color,
                      txt_color, high_color),
                ...
                new Flexible(
                  ...
                  mainAxisAlignment: MainAxisAlignment.start,
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: createRow_2(ach_list, project_list, skill_list,
                      color, txt_color, high_color),
                  // <Widget>[
                  //   pdf_achievement(ach_list, color, txt_color, high_color),
                  //   pdf_project_work(project_list, color, txt_color, high_color, "Projects"),
                  //   pdf_skill_lang(skill_list, color, txt_color, high_color, "Skills"),
    ...
    children: <Widget>[
      ...
      new Padding(
          ...
          child: new Column(
            mainAxisAlignment: MainAxisAlignment.start,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: createRow_1(
                edu_list, work_list, lang_list, color, txt_color, high_color),
          )),
      ...
      new Padding(
          ...
          child: new Column(
            mainAxisAlignment: MainAxisAlignment.start,
            crossAxisAlignment: CrossAxisAlignment.start,
            children: createRow_2(ach_list, project_list, skill_list, color,
                txt_color, high_color),
          )),
...
Widget pdf_skill_lang(List<Skills_Languages_UserModel>? skilang_list,
    String? color, String txt_color, String high_color, String? categ) {
...
skilangs(int index, List<Skills_Languages_UserModel>? skilang_list,
    String? high_color, String? color) {
  return skilang_details(
      skilang_list?.elementAt(index).value, high_color, color);
}
...
Widget pdf_achievement(List<Achievements_UserModel>? ach_list, String? color,
    String txt_color, String high_color) {
  PdfColor set_color(String? str) {
    if (str == "teal") {
      return PdfColors.teal;
    } else if (str == "blueGrey") {
...
achs(int index, List<Achievements_UserModel>? ach_list, String? high_color) {
  return ach_details(ach_list?.elementAt(index).qualification_name,
      ach_list?.elementAt(index).organization_name, high_color);
}
...
Widget pdf_project_work(List<Work_Projects_UserModel>? prowork_list,
    String? color, String txt_color, String high_color, String categ_name) {
  PdfColor set_color(String? str) {
    if (str == "teal") {
      return PdfColors.teal;
    } else if (str == "blueGrey") {
...
projects_works(int index, List<Work_Projects_UserModel>? prowork_list,
    String? high_color) {
  return prowork_details(
      prowork_list?.elementAt(index).qualification_name,
      prowork_list?.elementAt(index).organization_name,
      prowork_list?.elementAt(index).brief,
      prowork_list?.elementAt(index).year_duration,
      high_color);
}

Widget prowork_details(String? course_name, String? org_name, String? brief,
    String? year, String? high_color) {
  PdfColor set_color(String? str) {
    if (str == "teal") {
      return PdfColors.teal;
    } else if (str == "blueGrey") {
...
Widget pdf_education(List<Education_UserModel>? edu_list, String? color,
    String txt_color, String high_color) {
  PdfColor set_color(String? str) {
    if (str == "teal") {
      return PdfColors.teal;
...
courses(int index, List<Education_UserModel>? edu_list, String? high_color) {
  return pdf_course_details(
      edu_list?.elementAt(index).qualification_name,
      edu_list?.elementAt(index).organization_name,
      edu_list?.elementAt(index).year_duration,
      high_color);
}

Widget pdf_course_details(
    String? course_name, String? org_name, String? year, String? high_color) {
  PdfColor set_color(String? str) {
    if (str == "teal") {
      return PdfColors.teal;
    } else if (str == "blueGrey") {
